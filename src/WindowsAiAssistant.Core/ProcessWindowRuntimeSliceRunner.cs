...
public sealed class ProcessWindowRuntimeSliceRunner : IProcessWindowRuntimeSliceRunner, IRuntimeSlice
{
    public const string SliceName = "process-window";
    public const int SlicePriority = 20;

    private readonly IStepRuntimeEngagementBoundary _engagementBoundary;
    private readonly IStepEntryDecider _stepEntryDecider;
    private readonly ProcessWindowStepFollowUpDecider _stepFollowUpDecider;
    private readonly StepRuntimeCoordinator _stepRuntimeCoordinator;

    public ProcessWindowRuntimeSliceRunner(
        IStepRuntimeEngagementBoundary engagementBoundary,
        IStepEntryDecider stepEntryDecider,
        ProcessWindowStepFollowUpDecider stepFollowUpDecider,
    ...
    public async Task<ProcessWindowRuntimeSliceResult> TryRunAsync(
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        {
            return new ProcessWindowRuntimeSliceResult
            {
