...
internal static class PlaybookPromptHints
{
    internal static void Append(StringBuilder builder, string userGoal, DesktopObservation observation)
    {
        ...
        {
            builder.AppendLine("MANDATORY — NEW DOCUMENT GOAL:");
            builder.AppendLine("- FIRST action MUST be press_shortcut with target Ctrl+N (or com_invoke when progId is known).");
        ...
        {
            builder.AppendLine("MANDATORY — SAVE DOCUMENT GOAL:");
            builder.AppendLine("- FIRST action MUST be press_shortcut with target Ctrl+S.");
        ...
        {
            builder.AppendLine("MANDATORY — CLIPBOARD READ GOAL:");
            builder.AppendLine("- FIRST action MUST be clipboard with parameters.mode=read.");
        ...
        {
            builder.AppendLine("MANDATORY — SELECT ALL GOAL:");
            builder.AppendLine("- FIRST action MUST be press_shortcut with target Ctrl+A.");
